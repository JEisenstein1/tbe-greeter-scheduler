...
export default async function handler(req, res) {
  ...
  try {
    ...
    await sql`UPDATE slots SET volunteer_name=NULL, volunteer_email=NULL, coverage_requested=FALSE, updated_at=NOW() WHERE id=${slotId}`;
    await logAudit(sql, user.email, 'remove_assignment', 'slot', slotId, {});
